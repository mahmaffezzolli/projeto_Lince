      ...
      children: <Widget>[
        Container(
          ...
          child: TypeAheadFormField<Store>(
            ...
            suggestionsCallback: (pattern) async {
              final List<Store> stores = await Provider.of<StoreController>(context, listen: false).getAllStores();
            ...
            onSuggestionSelected: (suggestion) {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      StoreDetailsScreen(store: suggestion),
                ),
              );
            },
          ),
        ...
        Expanded(
          child: FutureBuilder<List<Store>>(
            key: UniqueKey(),
            future: Provider.of<StoreController>(context, listen: true)
                .getAllStores(),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Column(
                      children: [
                        ...
                        ListTile(
                          leading: Icon(
                            Icons.store, // Ícone que você deseja usar
                              ...
                              IconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (updatedStore != null) {
                                    Provider.of<StoreListProvider>(context,
                                        listen: false)
                                  ...
                                  showDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      return AlertDialog(
                                        ...
                                        content: const Text('Tem certeza de que deseja excluir esta loja?'),
                                        actions: <Widget>[
                                          TextButton(
                                          ...
                                          TextButton(
                                            ...
                                            onPressed: () async {
                                              ...
                                              print('Deleting store: ${store.id} - ${store.name}');
